...
function addCityData(city, country, localtime) {
  ...
  time.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(localtime), 'PPPP | HH:mm');
